...
def custom_progress_bar(value, text="Processing...", max_val=100):
    """Create a custom purple progress bar that works on Streamlit Cloud"""
    percentage = (value / max_val) * 100
    st.markdown(f"""
    <div style="margin: 10px 0;">
        <div style="color: #666; margin-bottom: 5px; font-size: 14px;">{text}</div>
...
def main():
    # FIRST: Force purple progress bars immediately for Streamlit Cloud
    st.markdown("""
    <style>
    /* CRITICAL: Purple progress bars - Load FIRST for Streamlit Cloud */
    .stProgress > div > div > div > div {
        background-color: #8B5CF6 !important;
        background-image: linear-gradient(90deg, #8B5CF6, #A855F7) !important;
    }
    [data-testid="stProgress"] > div > div > div > div {
        background-color: #8B5CF6 !important;
        background-image: linear-gradient(90deg, #8B5CF6, #A855F7) !important;
    ...
    *[class*="progress"] *[class*="bar"] {
    ...
    try:
        st.image("logo_aicrete.png", width=300)
    except Exception:
    ...
    with st.sidebar:
        ...
        try:
            st.image("logo_aicrete.png", width=150)
        except Exception:
